...
import weatherImage from'../image/rainy-day.png'
...
const ListApp = (props) => {
    ...
    return (
        <div className='container-fluid container-md pb-5'>
            <div className="row">
            ...
            <div className='row mt-2'>
                <div className='col d-flex justify-content-center'>
                    <article className="leaderboard">
                        <header>
                        <svg x="0px" y="0px" viewBox="0 0 511.999 511.999" className="leaderboard__icon">
                            <g>
                                <g>
                            ...
                            <h1 className="leaderboard__title">
                                <span className="leaderboard__title--top">List App</span>
                                <span className="leaderboard__title--bottom">Made by Me ^^</span>
                            </h1>
                        </header>
    
                        <main className="leaderboard__profiles">
                            <Link to='todo-app' className='leaderboard__profile'>
                                <img src={todoAppImage} alt="Toto App" className="leaderboard__picture"/>
                                <span className="leaderboard__name">Todo App</span>
                            </Link>
                            <Link to='weather-app' className="leaderboard__profile">
                                <img src={weatherImage} alt="Weather App" className="leaderboard__picture"/>
                                <span className="leaderboard__name">Weather App</span>
                            </Link>
                        </main>
                    </article>
                </div>
